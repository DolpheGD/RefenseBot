...
# top.gg API v1 token for this bot. Find/generate it under your project's
# "Integrations & API" settings on top.gg. Must be a v1 token (older
# webhook-era "legacy" tokens will NOT work here) - used to poll top.gg
# for votes directly, no public server or webhook needed.
TOPGG_TOKEN=
"""
